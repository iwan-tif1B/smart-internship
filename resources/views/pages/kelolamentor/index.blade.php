...
@push('style')
    ...
    .icon-button:hover {
        ...
        text-align: center; /* Pastikan teks header tetap di tengah jika diinginkan */
    }
    ...
    .table tbody td:last-child {
        text-align: center; /* Tengahkan konten di kolom "Aksi" */
    }
        ...
        .modal-tambah-mentor .modal-dialog-centered {
            max-width: 400px; /* Lebar modal tambah mentor */
        }
                        ...
                        <tbody>
                            @php
                                $mentors = [
                                    ...
                                    // Tambahkan data mentor lain di sini (idealnya dari database)
                                ];
                            @endphp
                            ...
                            @foreach ($mentors as $key => $mentor)
                                <tr>
                                    ...
                                    <td class="align-middle">{{ $mentor['posisi'] }}</td>

...
@push('style')
    ...
    .table thead th {
        ...
        font-weight: bold;
        vertical-align: middle; /* Pastikan ini ada */
        text-align: center; /* Pertahankan jika Anda ingin teks header tetap di tengah */
    }
    ...
    .table tbody td {
        vertical-align: middle; /* Pastikan semua isi sel berada di tengah vertikal */
    }

    .table tbody td:nth-child(10), /* Kolom Dokumen */
    .table tbody td:nth-child(11) { /* Kolom Aksi */
        text-align: center; /* Pastikan konten di kolom ini tetap di tengah */
    }
        .table thead {
            background-color: #3c4b64;
            color: white;
        ...
        .modal-content-custom {
            ...
            padding: 20px 30px; /* Kurangi padding atas dan bawah */
            text-align: center;
        }

        .modal-icon {
            width: 80px; /* Sedikit kecilkan ikon lagi */
            height: 80px;
            border-radius: 50%;
            ...
            justify-content: center;
            align-items: center;
            font-size: 60px; /* Kecilkan font ikon */
            margin: 0 auto 15px; /* Kurangi margin bawah ikon */
        }

        .modal-title-custom {
            font-size: 25px; /* Kecilkan ukuran judul */
            font-weight: bold;
            color: #333;
        ...
        .modal-message-custom {
            color: #555;
            margin-bottom: 0px; /* Kurangi margin bawah pesan */
            font-size: 15px; /* Kecilkan ukuran pesan */
        }
        ...
        .modal-buttons-custom {
            ...
            justify-content: center;
            gap: 10px;
            margin-top: 0px; /* Kurangi margin atas tombol */
        ...
        .btn-secondary-custom {
            ...
            color: #fff; /* Ubah warna teks menjadi putih agar terlihat jelas di atas latar merah */
            border: none;
            border-radius: 6px;
            padding: 10px 20px;
            font-size: 15px;
        ...
        .btn-primary-custom:hover {
            background-color: #134a96; /* Warna biru lebih gelap saat hover */
        }

        .btn-secondary-custom:hover {
            background-color: #b8181e; /* Warna merah lebih gelap saat hover */
            color: #fff;
        }
        .dropdown {

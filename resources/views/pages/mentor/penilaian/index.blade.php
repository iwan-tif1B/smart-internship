            ...
            <table class="table table-striped table-rounded" id="tabel-penilaian">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">{{ optional($item->mentor)->nama ?? '-' }}</td>
                        <td class="text-center align-middle">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="aksiDropdownPenilaian{{ $item->id }}">
                                    <a href="#" class="dropdown-item"><i class="bi bi-pencil"></i> Edit</a>
                                    <div class="dropdown-divider"></div>
                                    <a href="#" class="dropdown-item"><i class="bi bi-eye-fill"></i> Detail</a>
                                </div>
                            </div>
                        </td>
                    </tr>
...
@endsection
@push('scripts')
<!-- jQuery dan Popper (dibutuhkan oleh Bootstrap dropdown) -->
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.1/dist/umd/popper.min.js"></script>

<!-- Bootstrap JS (versi 4 sesuai dengan data-toggle="dropdown") -->

                ...
                <table class="table table-striped table-rounded">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">{{ $item->detail->persentasi ?? '0%' }}</td>
                            <td class="text-center align-middle">
                                @if ($item->status)
                                <span class="badge-status badge-inactive">Diterima</span>
                                @else
                                <span class="badge-status badge-active">Revisi</span>
                                @endif
                            </td>
                            <td class="text-center">
                                <a href="{{ route('detailmonitoring.index') }}" class="icon-button detail-btn-detail">

            ...
            <div class="action-bar">
                <div class="aksi-container">
                    ...
                    <div class="aksi-menu" aria-labelledby="aksiButton">
                        ...
                        @if(isset($template))
                            <a class="aksi-item" href="{{ route('sertifikat.download', $template->id) }}">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="ubahTemplateForm" action="{{ route('sertifikat.update', isset($template) ? $template->id : '') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            $('.aksi-item[href*="sertifikat.edit"]').on('click', function(e) {
                e.preventDefault();

    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
                ...
                <!-- Search -->
                <form action="{{ route('pendaftarmagang.index') }}" method="GET" class="mr-2 mb-2" style="flex-grow: 1; max-width: 730px;">
                ...
                <!-- Export PDF -->
                <a href="{{ route('pendaftarmagang.export.pdf') }}"

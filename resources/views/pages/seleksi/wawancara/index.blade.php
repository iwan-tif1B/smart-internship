                ...
                <div class="col-md-8">
                    <form action="{{ route('wawancara.index') }}" method="GET">
                        <div class="position-relative">
                            ...
                            <input type="text" name="nama" value="{{ request('nama') }}" class="form-control pl-5 shadow-sm"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                {{ \Carbon\Carbon::parse($item->tanggal_wawancara)->translatedFormat('d M Y') }}
                            <td>{{ $item->link_wawancara}}</td>
                            </td>
                            <td class="text-center">
                                @if ($item->status_wawancara == 'proses')
                                <span class="badge-status badge-proses">Proses</span>
                                @elseif ($item->status_wawancara == 'diterima')
...
<script>
    $(document).ready(function() {
        $('.terima-btn').on('click', function() {
            var id = $(this).data('id');
            $('#terimaForm').attr('action', '/wawancara/' + id + '/terima');
        ...
        $('.tolak-btn').on('click', function() {
            var id = $(this).data('id');
            $('#tolakForm').attr('action', '/wawancara/' + id + '/tolak');

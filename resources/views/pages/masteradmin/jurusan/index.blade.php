                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content modal-content-custom">
                                            ...
                                            <div class="modal-body modal-message-custom">
                                                Apakah Anda yakin ingin menghapus jurusan <strong><span id="namaJurusanDelete{{ $jurusan['id'] }}"></span></strong>?
                                                <form id="deleteFormJurusan{{ $jurusan['id'] }}" method="POST" action="{{ route('jurusan.destroy', $jurusan['id']) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
                                            <div class="modal-footer modal-buttons-custom">
                                                ...
                                                <button type="submit" class="btn btn-primary btn-primary-custom" form="deleteFormJurusan{{ $jurusan['id'] }}">Hapus</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function() {
        // Inisialisasi modal tambah jurusan (opsional)
        $('#tambahJurusanModal').on('show.bs.modal', function(e) {
        ...
        // Simpan jurusan (AJAX)
        $('.simpan_jurusan').on('click', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    // Reset form
                    $('#tambahJurusanModal form')[0].reset();

                            ...
                            @php
                                $dummyPositions = [
                                    [
                                        ...
                                        'total_kuota' => 10,
                                        'kuota_tersedia' => 5,
                                        'persyaratan' => 'Menguasai seluruh bahasa pemrograman',
                                        'status' => 'publish',
                                    ],
                                    [
                                        'id' => 2,
                                        ...
                                        'total_kuota' => 7,
                                        'kuota_tersedia' => 4,
                                        'persyaratan' => 'Memiliki kemampuan analisis yang baik',
                                        'status' => 'unpublish',
                                    ],
                                    // Tambahkan data posisi lain di sini jika ada
                                ];
                            @endphp

                            @foreach ($dummyPositions as $key => $posisi)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>{{ $posisi['nama'] }}</td>
                                            ...
                                            <div class="modal fade" id="unpublishModalPosisi{{ $posisi['id'] }}" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content modal-content-custom">
                                                        ...
                                                        <h5 class="modal-title modal-modal-title-custom" id="unpublishModalPosisiLabel{{ $posisi['id'] }}">Konfirmasi Unpublish</h5>
                                                        <div class="modal-body modal-message-custom">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            $('.publish-btn-posisi').on('click', function () {
                var id = $(this).data('id');
            ...
            $('.unpublish-btn-posisi').on('click', function () {
                var id = $(this).data('id');
                var nama = $(this).data('nama');
                $('#namaPosisiUnpublish' + id).text(nama);
                $('#unpublishModalPosisi' + id).modal('show');
            });

            $('.delete-btn-posisi').on('click', function () {
                var id = $(this).data('id');
                var nama = $(this).data('nama');

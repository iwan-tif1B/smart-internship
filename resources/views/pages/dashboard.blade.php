                    ...
                    <div class="card card-statistic-1">
                        <div class="card-wrap">
                            <div class="card-header">
                                <h2 style="color:black">Booking Rent Playstation</h2>
                                <h1 style="font-weight: bold">Home</h1>
                                <i class="lead">
                                    Selamat Datang <strong class="font-weight-bold">{{ auth()->user()->name }}</strong><br>
                                    Silahkan gunakan aplikasi <strong class="font-weight-bold">Home</strong> sesuai hak
                                    akses yang
                                    telah diberikan. Jika terjadi permasalahan, Silahkan Hubungi Administrator. </i>
                            </div>
                            <div class="card-body">
                                {{-- 10 --}}
                            </div>

    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1 class="section-title">Template Penilaian</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></div>
                    <div class="breadcrumb-item">Template Penilaian</div>
                </div>
            </div>
                ...
                <div class="aksi-container">
                    ...
                    <div class="aksi-menu" aria-labelledby="aksiButton">
                        ...
                        <a class="aksi-item" href="#" data-toggle="modal" data-target="#formatTemplateModal">
                            ...
                            <a class="aksi-item" href="', $templatePenilaian->id) }}">
            ...
            <div class="template-container">
                @if(isset($templatePenilaian))
                    <div class="template-preview">
                        <img src="{{ asset('path/ke/gambar/template_penilaian.png') }}" alt="Pratinjau Template Penilaian">
                        {{-- Ganti 'path/ke/gambar/template_penilaian.png' dengan path gambar template penilaian Anda --}}
                    </div>
                ...
                @else
                    <p>Belum ada template penilaian. Silakan tambahkan template baru.</p>
                @endif
            </div>
        </section>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ubahTemplateModalLabel">Ubah Template Penilaian:</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="ubahTemplateForm"  method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <img src="{{ asset('path/ke/gambar/contoh_format_template_penilaian.png') }}" alt="Contoh Format Template Penilaian" class="img-fluid">
                            <small class="form-text text-muted">Pastikan template Anda mengikuti format ini.</small>
                        </div>
                        <div class="col-md-6">
                            <p><strong>Persyaratan:</strong></p>
                            <ul>
                                <li>Pastikan di dalam template terdapat placeholder untuk nilai.</li>
                                <li>Contoh placeholder: <code>{{ '{' }}{'nilai_bagian_1'}{'}' }}</code></li>
                                <li>Sesuaikan placeholder dengan kebutuhan penilaian Anda.</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            // Event listener untuk menampilkan modal ubah template
            $('.aksi-item[href*="#ubahTemplateModal"]').on('click', function(e) {
                e.preventDefault();
                $('#ubahTemplateModal').modal('show');
            });

            // Event listener untuk menampilkan modal format template
            $('.aksi-item[href*="#formatTemplateModal"]').on('click', function(e) {
                e.preventDefault();

                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="icon-button detail-btn-testimoni" data-toggle="modal" data-target="#detailTestimoniModal{{ $item['id'] }}" data-nama="{{ $item->nama->name }}" data-instansi="{{ $item->nama->posisi->nama }}" data-posisi="{{ $item->nama->posisi->nama }}" data-testimoni="{{ $item->content }}" aria-label="Lihat detail testimoni {{ $item['id'] }}">
                                    <i class="fas fa-eye"></i>
                                </button>
                            </td>
                        </tr>

                        <div class="modal fade" id="detailTestimoniModal{{ $item['id'] }}" tabindex="-1" role="dialog" aria-labelledby="detailTestimoniModalLabel{{ $item['id'] }}" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="detailTestimoniModalLabel{{ $item['id'] }}">Detail Testimoni</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <p><strong>Nama:</strong> <span id="detail-nama-{{ $item ['id'] }}"></span></p>
                                        <p><strong>Instansi:</strong> <span id="detail-instansi-{{ $item ['id'] }}"></span></p>
                                        <p><strong>Posisi:</strong> <span id="detail-posisi-{{ $item ['id'] }}"></span></p>
                                        <p><strong>Testimoni:</strong> <span id="detail-testimoni-{{ $item ['id'] }}"></span></p>
                                    </div>

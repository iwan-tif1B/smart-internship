...
@push('style')
    ...
    <style>
        ...
        .row-flex {
            display: flex;
            flex-wrap: wrap;
            justify-content: space-between; /* Menambahkan jarak antara kolom */
        }

        .col-md-6 {
            flex: 0 0 calc(50% - 10px); /* Lebar 50% dikurangi jarak antar kolom */
        ...
        .form-group-custom {
            margin-right: 10px; /* Memberi jarak pada input dan button */
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('kriteria.index') }}">Template Kriteria Penilaian</a></div>
            ...
            <div class="section-body">
                <div class="card card-custom">
                    <h2 class="card-title-custom">Programmer</h2> {{-- Ini Nama Posisi, nanti diganti dengan data dari controller --}}
                    ...
                    <form action="{{ route('kriteria.store') }}" method="POST">
                        ...
                        <div class="form-actions">
                            <a href="{{ route('kriteria.index') }}" class="btn btn-secondary-custom">Kembali</a>

                        ...
                        <div class="row">
                            <div class="col-lg-4 mb-4">
                                <div class="card sidebar-custom">
                                    ...
                                    <p class="small text-muted mb-1">
                                        Pastikan Anda mengisi laporan progres projek Anda dan
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="card content-custom mb-4">
                                    <h6 class="fw-bold">Detail Laporan Projek</h6>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="persentase" min="0" max="100">
                </div>
            </div>
